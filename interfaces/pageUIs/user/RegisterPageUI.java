...
public class RegisterPageUI {
	...
	public static final String EMAIL_TXTBOX = "ID=Email";
	public static final String PASSWORD_TXTBOX = "ID=Password";
	public static final String CONFIRM_PASSWORD_TXTBOX = "ID=ConfirmPassword";
	public static final String REGISTER_BTN = "ID=register-button";
	...
	public static final String SUCCESS_REGISTER_MSG = "CLASS=result";
